 ...
 */
class AutoAppBarLayout : AppBarLayout {
    ...
    override fun generateLayoutParams(attrs: AttributeSet): LayoutParams {
        return AutoAppBarLayout.LayoutParams(context, attrs)
    }


    class LayoutParams : AppBarLayout.LayoutParams, AutoLayoutHelper.AutoLayoutParams {
